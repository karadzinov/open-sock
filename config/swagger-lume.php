...
return [
    ...
    */
    'security' => [
        ...
        */
        'oauth2_security' => [ // Unique name of security
            'type' => 'oauth2', // The type of the security scheme. Valid values are "basic", "apiKey" or "oauth2".
            'description' => 'Passport auth for generating access token',
            'flow' => 'password', // The flow used by the OAuth2 security scheme. Valid values are "implicit", "password", "application" or "accessCode".
            'authorizationUrl' => env('APP_URL').'/auth/token', // The authorization URL to be used for (implicit/accessCode)
            'tokenUrl' => env('APP_URL').'/oauth/token', // The authorization URL to be used for (password/application/accessCode)
            'scopes' => [
                'admin' => 'Access with admin rights',
                'sapo' => 'Access as user',
            ]
        ],
    ],
