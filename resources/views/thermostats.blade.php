        ...
        <div class="row">
            <table class="table table-hover mt-5">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Thermostat</th>
                        <th scope="col">Room Temp.</th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($all_thermostats as $therms)
                    <tr>
                        <th scope="row">{{$therms->id}}</th>
                        <td>{{$therms->room_name}}</td>
                        <td>{{$therms->room_temp}} &#x2103</td>
                        <td><a class="btn btn-outline-info" href="{{ url('thermostat/'. $therms->id )}}" role="button"><i class="fas fa-cog"></i> settings</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
